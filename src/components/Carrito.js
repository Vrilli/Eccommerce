...
const Carrito = () => {
  ...
  return (
    <div className="cart-Container">
       <div  onClick={() => setCartOpen(!cartOpen)} className="button-cart-Container">
        ...
        {!cartOpen && (
          <div className="products-Number">{productsLength}</div>
        )}
      </div>
      ...
      {cartItems && cartOpen && (
        <div className="car">
          ...
          {cartItems.length === 0 ? (
            <p className="car-vacio">Tu carrito esta vacio</p>
          ) : (
